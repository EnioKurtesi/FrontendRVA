...
import { STUDENT_URL, STUDENT_ZA_DEPARTMAN_URL } from '../app.constants';
...
export class StudentService {
  ...
  public getStudenteByDepartman(idDepartmana: number): Observable<any> {
    return this.httpClient.get(`${STUDENT_ZA_DEPARTMAN_URL}/${idDepartmana}`);
  }
